	...
	public void setTutStage(int act){
		...
		switch (act){
			...
			case 1:
				...
				Lines[13] = "you encounter it you can defend yourself by pressing SPACE while  ";
				Lines[14] = "facing it in meleerange.";
				Lines[15] = "";
				Lines[16] = "";
				Lines[17] = "";
				Lines[18] = "Press t anytime to hide or display this text. ";
			...
			case 2:
				...
				Lines[9] = "kind of superstitious hogwash!";
				Lines[10] = "Let's rather move on. There is supposed to be an old forgotten fort just  ";
				Lines[11] = "south of here. And you know what they say about forgotten Forts: There ";
				Lines[12] = "is allways a hidden treasure somewhere.";
				Lines[13] = "";
				Lines[14] = "";
				Lines[15] = "";
				Lines[16] = "";
			...
			case 4:
				...
				Lines[3] = "";
				Lines[4] = "Try and equip it by pressing e when you have selected it in your";
				Lines[5] = "inventory.";
				Lines[6] = "";
			...
			case 5:
				...
				Lines[1] = "";
				Lines[2] = "This Octobubble ahead seems to be much stronger and even more ";
				Lines[3] = "intellingent than the others we have encountered. ";
				Lines[4] = "";
				Lines[5] = "";
