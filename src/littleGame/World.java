...
public class World {
	...
	public World(int hight, int width){
		...
		String doorVPATH = new File ("Images/door-vertical-closed.png").getAbsolutePath();
		String doorHPATH = new File ("Images/door-horizontal-closed.png").getAbsolutePath();
		String doorHOPATH = new File ("Images/door-horizontal-open.png").getAbsolutePath();
		String doorVOPATH = new File ("Images/door-vertical-open.png").getAbsolutePath();
		String wallSecPATH = new File ("Images/wall-cross.png").getAbsolutePath();
		String wallHPATH = new File ("Images/wall-horizontal.png").getAbsolutePath();
		String wallVPATH = new File ("Images/wall-vertical.png").getAbsolutePath();
